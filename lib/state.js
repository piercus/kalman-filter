...
/**
 * @class
 * Class representing a multi dimensionnal gaussian, with his average(point.mean) and his sigma(point.covariance)
 ...
 * @property {Array.<Number>} mean array of size dimension
 */
class State {
	/**
   * Create a State
